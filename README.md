...
- Smartlink placement: rendered beside the next-gate button in the bottom action section.
- Popunder behavior: included in randomized slot mixing so it does not appear on every page load.
